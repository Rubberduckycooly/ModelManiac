...
namespace PegasusEngine.Extensions.ImageBox
{
  // Cyotek ImageBox
  ...
  /* [Designer("Cyotek.Windows.Forms.Design.ImageBoxDesigner", Cyotek.Windows.Forms.ImageBox.Design.dll, PublicKeyToken=58daa28b0b2de221")] */ public class ImageBox : VirtualScrollableControl
  {
    ...
    public virtual void CenterAtX(Point imageLocation)
    {
      this.ScrollToX(imageLocation, new Point(this.ClientSize.Width / 2, this.ClientSize.Height / 2));
    }
    ...
    public void OffsetImage(float x, float y)
    {
            this.CenterAtX(new Point((int)x, (int)y));
    }
    ...
    public virtual void ScrollTo(Point imageLocation, Point relativeDisplayPoint)
    {
      ...
      this.AutoScrollPosition = new Point(x, y);
        ...
        public virtual void ScrollToX(Point imageLocation, Point relativeDisplayPoint)
        {
            int x;
            int y;
